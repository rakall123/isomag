...
<table  style="width: 30%;position: absolute;left:20%;top:30%;background-color:white;text-emphasis-color: black;" >
<tr style="border-collapse: separate; border-spacing: 40px;">
    <td style="padding-right: 10px" height="119">
 ...
 <input style="width:200px;" type="hidden" name="coid" width ="70%"id="co651" value="<?php echo $row->containersize ?>" />
   <input style="width:200px;" type="hidden" name="mid" width ="70%"id="co651" value="<?php echo $row->manufacturer ?>" />          
             <input type="submit" <?php if ($et1=="SLOT 1"){echo 'disabled="" '; }?>  id='<?php echo $set1?>'   name="slot1" style="color:black;border:none;height:180px;width:100px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set1; ?>;" value="<?php echo $et1 ?>" ></input>
</form>
</td>
<td style="padding-right: 10px" >
  ...
  <input  type="submit" <?php if ($et2=="SLOT 2"){echo 'disabled="" '; }?>  name="slot2" id="<?php echo $set2?>" style="color:black;border:none;width:100px;height:180px;border-width: 2px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set2; ?>;"  value="<?php echo $et2?>"></input>
</form>
</td>
<td height="112" style="padding-right: 10px">
 ...
 <input style="width:200px;" type="hidden" name="coid3" width ="70%"id="c78751" value="<?php echo $row3->containersize ?>" />
  ...
  <input type="submit" <?php if ($et3=="SLOT 3"){echo 'disabled="" '; }?>  name="slot3" id="<?php echo $set3?>" style="color:black;border:none;width:100px;height:180px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set3; ?>;"  value="<?php echo $et3?>"></input>
</form></td>
...
<input type="submit"  name="slot4" <?php if ($et4=="SLOT 4"){echo 'disabled="" '; }?> id="<?php echo $set4?>" style="color:black;border:none;width:100px;height:180px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set4; ?>;" value="<?php echo $et4?>"></input>
</form></td>
<td height="119">
    <form id="form121" action="<?php echo site_url('workflow/formview') ?>" method="POST">
         <?php $snum9='9' ?>
 ...
 <input style="width:200px;" type="hidden" name="coid" width ="70%"id="co651" value="<?php echo $row->containersize ?>" />
   <input style="width:200px;" type="hidden" name="mid" width ="70%"id="co651" value="<?php echo $row->manufacturer ?>" />          
             <input type="submit" <?php if ($et1=="SLOT 9"){echo 'disabled="" '; }?>  id='<?php echo $set9?>'   name="slot9" style="color:black;border:none;height:180px;width:100px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set9; ?>;" value="<?php echo $et9 ?>" ></input>
</form>
</td>
</tr>

<tr>
<td height="123" style="padding-right: 10px">
...
<input type="submit" <?php if ($et5=="SLOT 5"){echo 'disabled="" '; }?>  name="<?php echo site_url('workflow/storewkflow')?>" id='<?php echo $set5?>' style="color:black;text-emphasis-color: black;border:none;width:100px;height:180px;background-color:#2E7091;background-color: <?php echo $set5; ?>;" value="<?php echo $et5?>"</input>
</form></td>
<td style="padding-right: 10px">
...
<input type="submit" <?php if ($et6=="SLOT 6"){echo 'disabled="" '; }?> name="slot6" id="<?php echo $set6?>" style="color:black;border:none;width:100px;height:180px;background-color:#2E7091;background-color: <?php echo $set6; ?>;" value="<?php echo $et6?>"></input>
</form></td>
<td style="padding-right: 10px">
...
<input type="submit" <?php if ($et7=="SLOT 7"){echo 'disabled="" '; }?>  name="slot7" id="<?php echo $set7?>" style="color:black;border:none;width:100px;height:180px;background-color:#2E7091;background-color: <?php echo $set7; ?>;" value="<?php echo $et7?>"></input>
</form></td>
<td>
      <form id="form821" action="<?php echo site_url('workflow/formview7') ?>" method="POST">
         <?php $snum7='8' ?>
...
<table style="width: 10%;position: absolute;right:2%;top:30%;background-color:white;text-emphasis-color: black;">
<tr>
<td height="119">
    <form id="form121" action="<?php echo site_url('workflow/formview') ?>" method="POST">
         <?php $snum10='10' ?>
 ...
 <input style="width:200px;" type="hidden" name="coid" width ="70%"id="co651" value="<?php echo $row->containersize ?>" />
   <input style="width:200px;" type="hidden" name="mid" width ="70%"id="co651" value="<?php echo $row->manufacturer ?>" />          
             <input type="submit" <?php if ($et1=="SLOT 10"){echo 'disabled="" '; }?>  id='<?php echo $set10?>'   name="slot10" style="color:black;border:none;height:140px;width:120px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set10; ?>;" value="<?php echo $et10 ?>" ></input>
</form>
</td>
</tr>
<tr>
<td height="119">
 ...
 <input style="width:200px;" type="hidden" name="coid" width ="70%"id="co651" value="<?php echo $row->containersize ?>" />
   <input style="width:200px;" type="hidden" name="mid" width ="70%"id="co651" value="<?php echo $row->manufacturer ?>" />          
             <input type="submit" <?php if ($et1=="SLOT 11"){echo 'disabled="" '; }?>  id='<?php echo $set11?>'   name="slot11" style="color:black;border:none;height:140px;width:120px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set11; ?>;" value="<?php echo $et11 ?>" ></input>
</form>
</td>
</tr>
</table>
<table style="width: 10%;position: absolute;right:13.5%;top:85%;background-color:white;text-emphasis-color: black;">
<tr>
<td height="119">
    <form id="form121" action="<?php echo site_url('workflow/formview') ?>" method="POST">
         <?php $snum12='12' ?>
 ...
 <input style="width:200px;" type="hidden" name="coid" width ="70%"id="co651" value="<?php echo $row->containersize ?>" />
   <input style="width:200px;" type="hidden" name="mid" width ="70%"id="co651" value="<?php echo $row->manufacturer ?>" />          
             <input type="submit" <?php if ($et1=="SLOT 12"){echo 'disabled="" '; }?>  id='<?php echo $set12?>'   name="slot12" style="color:black;border:none;height:100px;width:130px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set12; ?>;" value="<?php echo $et12 ?>" ></input>
</form>
</td>
<td height="119"style="padding-left: 10px">
    <form id="form121" action="<?php echo site_url('workflow/formview') ?>" method="POST">
         <?php $snum13='13' ?>
        <?php $row = $this->work_model->get_by_slotnumber($snum); ?> 
             <input type="hidden" style="position:absolute;top:79%;width:71px;height:25px;" name="wokid" value="<?php echo $row->workorderid ?>" id="f21e41" />
 ...
 <input style="width:200px;" type="hidden" name="coid" width ="70%"id="co651" value="<?php echo $row->containersize ?>" />
   <input style="width:200px;" type="hidden" name="mid" width ="70%"id="co651" value="<?php echo $row->manufacturer ?>" />          
             <input type="submit" <?php if ($et1=="SLOT 13"){echo 'disabled="" '; }?>  id='<?php echo $set13?>'   name="slot13" style="color:black;border:none;height:100px;width:130px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set13; ?>;" value="<?php echo $et13 ?>" ></input>
</form>
</td>
</tr>

</table>
<table style="width: 10%;position: absolute;right:13%;top:45%;background-color:white;text-emphasis-color: black;">
<tr>
<td height="119">
    <form id="form121" action="<?php echo site_url('workflow/formview') ?>" method="POST">
         <?php $snum14='14' ?>
 ...
 <input style="width:200px;" type="hidden" name="coid" width ="70%"id="co651" value="<?php echo $row->containersize ?>" />
   <input style="width:200px;" type="hidden" name="mid" width ="70%"id="co651" value="<?php echo $row->manufacturer ?>" />          
             <input type="submit" <?php if ($et1=="SLOT 14"){echo 'disabled="" '; }?>  id='<?php echo $set14?>'   name="slot14" style="color:black;border:none;height:140px;width:120px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set14; ?>;" value="<?php echo $et14 ?>" ></input>
</form>
</td>
</div>
